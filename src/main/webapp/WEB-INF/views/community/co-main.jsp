...
<jsp:include page="/WEB-INF/views/common/header.jsp" />
	...
	<div id="wrapper container" class="co">
		...
		<!-- Sidebar -->
		<section id="sidebar" class="col-lg-3 menu-trigger">
			<section class="sidebar-post-list">
				<nav class="sidebar_nav">
					<ul>
						<li class="menu active">
							<a href="#menu"><i class="fa fa-circle-thin"></i>전체 포스트</a>
						</li>
						<li class="menu">
							<a href="#menu"><i class="fa fa-circle-thin"></i>팔로잉 포스트</a>
						</li>
						<li class="menu">
							<a  href="#menu"><i class="fa fa-circle-thin"></i>판매자 포스트</a>
						</li>
						<li class="menu">
							<a href="#menu"><i class="fa fa-circle-thin"></i>댓글 포스트</a>
						</li>
						<li class="menu">
							<a href="#menu"><i class="fa fa-circle-thin"></i>좋아요 포스트</a>
						</li>
					</ul>
					<form id="sidebar_search" class="d-flex" method="get" action="#">
			...
			<section>
				<ul class="posts">
					<li>
						<div class="divlist" onclick="location.href='#'">
