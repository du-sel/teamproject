...
<div id="wrapper container" class="co">
	<main id="co-main" class="row" style="margin-top: 200px">
					...
					<div class="header">
						<div class="meta">
							<a href="#" class="author"><img src="/resources/images/춘식이프로필.png" alt="" />&nbsp;&nbsp;
								<span class="name"><input type="text" readonly="readonly" name="id" value="춘식이폼미쳤다" class="author"></span>
							</a>
		...
		<!-- Post -->
		<article class="post">  <!-- onclick="window.location.href = 'post.do';" -->
			<form action="/community/posts/${post.id}" method="get">
			<!--<input type="hidden" name="post_id"> biz~ 메소드에서 session에 저장하기-->
				<div>
					<div class="title">
						<p>
							<a href="#" class="author"><img src="/resources/images/춘식이프로필.png" alt="" />&nbsp;&nbsp;
								<span class="name"><input type="text" name="id" value="춘식이폼미쳤다" readonly="readonly" class="author"></span>
							</a>
						</p>
						<p>
							<input type="text" readonly="readonly" name="cre_date" class="published" value="2023-07-07">
						</p>
					</div>
				</div>
